...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('all_students.index', compact('data'))->with('i', (request()->input('page', 1) - 1) * 2);
    }
    ...
    {
        return view('all_students.create');
    }
    ...
    {
        return view('all_students.show', compact('student'));
    }
    ...
    {
        return view('all_students.edit', compact('student'));
    }
